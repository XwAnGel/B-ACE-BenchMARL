...
class B_ACE_GodotPettingZooWrapper(GodotEnv, ParallelEnv):
    ...
    def __init__(self,
        ...
        self.observation_spaces_pz = {agent: self.observation_space for agent in self.possible_agents}
        self.action_spaces_pz = {agent: self.action_space for agent in self.possible_agents}
        self.grouping_key = "agents"
